...
Additionally  this link: https://app.funnelai.com/shorten/JiXfGCEElA can be used to schedule, reschedule or cancel appointment by the user himself. 
Link should not be shown but provide click here option with link as background. 
